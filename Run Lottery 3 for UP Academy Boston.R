...
write.csv( out, "UAB Results/UAB Lottery 3 Results June 3 2015.csv", row.names = F, na = "")
write.csv( out.small, "UAB Results/UAB Lottery 3 Presentation Results June 3 2015.csv", row.names = F, na = "")

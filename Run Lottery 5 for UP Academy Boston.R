...
raw <- read.csv("UAB Source/2015-2016 UAB Lottery L5.csv", strip.white = TRUE)

set.seed(563914) # Change to a random number from random.org on lottery night
...
write.csv( out, "UAB Results/UAB Lottery 5 Results September 30 2015.csv", row.names = F, na = "")
write.csv( out.small, "UAB Results/UAB Lottery 5 Presentation Results September 30 2015.csv", row.names = F, na = "")
